                ...
                <aside className="sidebar" id="sidebar">
                    ...
                    <nav className="w-100 mb-4">
                        <ul className="nav-menu p-0 m-0">
                            ...
                            <li>
                                <a href="budget.html" className="nav-item-link active">
                    ...
                    <section className="glass-card-no-hover p-4 mb-4 animate-fade-in" style={{animationDelay: '0.05s'}}>
                        <div className="row align-items-center">
                            <div className="col-md-8">
                                <h4 className="fs-5 mb-1 text-white">Overall Monthly Spending Limit</h4>
                                <p className="text-muted small">You have used $2,410.20 out of your $4,500.00 total monthly limit.</p>
                                
                                <div className="budget-progress-container mb-0">
                                    <div className="budget-header small">
                                        <span className="text-muted">Spent: $2,410.20</span>
                                        <span className="text-muted">53% Utilized</span>
                                    </div>
                                    <div className="progress-bar-custom">
                                        <div className="progress-fill fill-primary" style={{width: '53.5%'}}></div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 text-md-end mt-3 mt-md-0">
                                <div className="d-inline-block text-start p-3 bg-dark border border-secondary rounded-4">
                                    <small className="text-muted d-block text-uppercase fw-bold tracking-wider fs-8">Remaining Funds</small>
                                    <span className="fs-4 fw-bold text-success">$2,089.80</span>
                                </div>
                            </div>
                        </div>
                    </section>
