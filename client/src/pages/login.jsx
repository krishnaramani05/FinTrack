                                ...
                                <form>
                                    <div className="mb-3">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input type="email" className="form-control border-start-0" id="loginEmail" placeholder="name@example.com" required/>
                                        </div>
                                    </div>

                                    <div className="mb-3">
                                        <div className="d-flex justify-content-between align-items-center mb-1">
                                            <label htmlFor="loginPassword" className="form-label m-0">Password</label>
